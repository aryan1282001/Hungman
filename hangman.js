var Hangman = (function () {
    ...
    function Hangman(elId) {
        ...
        // Possible words
        this.words      = [
            "ALTURUSG4", "ELENTRA", "CRETA", "VERNA", "IONIQ5", "TUCSON", "ALCAZAR", "SONOTA", "SPRESSO",
            "ERTIGA", "IGNIS", "GRANDVITARA", "WAGONR", "BALENO", "BREZZA", "NEXON", "HARRIER", "SAFARI",
            "PUNCH", "INDICA", "SELTOS" , "SONET", "INNOVA", "FORTUNER", "GLANZA", "VELLFIRE", "CAMRY",
            "SLAVIA", "OCTAVIA", "KUSHAQ", "SUPERB", "SCORPIO", "THAR", "MARAZZO", "BOLERO", "POLO", "VENTO", "VERTUS"
        ];
    }
...
// 'CULTURE', 'RAZORSHARP', 'SCREWDRIVER', 'TYPEWRITER',"NANO", 